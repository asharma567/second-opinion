...
echo " CITATION GATE [failure-mode B-002]: any specific numeric claim — prices, price"
echo " targets, dates, percentages, dosages — must carry a source citation from the"
echo " provider that asserted it. Drop unsourced numerics from the synthesis body and"
echo " surface them only in an 'unverified' footnote.)"
